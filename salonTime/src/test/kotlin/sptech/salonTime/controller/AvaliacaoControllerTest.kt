...
class AvaliacaoControllerTest {
 ...
 @Test
 @DisplayName("listarQuandoHaAvaliacoesDeveRetornarListaComStatus200")
 fun listarQuandoHaAvaliacoesDeveRetornarListaComStatus200() {
 ...
 @Test
 @DisplayName("buscarPorIdQuandoExisteDeveRetornarAvaliacaoComStatus200")
 fun buscarPorIdQuandoExisteDeveRetornarAvaliacaoComStatus200() {
 ...
 @Test
 @DisplayName("postQuandoValidoDeveCadastrarEAvaliacacaoComStatus201")
 fun postQuandoValidoDeveCadastrarEAvaliacacaoComStatus201() {
 ...
 @Test
 @DisplayName("putQuandoValidoDeveAtualizarEAvaliacaoComStatus200")
 fun putQuandoValidoDeveAtualizarEAvaliacaoComStatus200() {
